...
/// 
    ...
    public void hide_allpanel()
    {
        ...
        object[] divs = { this.FileManger, this.CMD, this.DBS ,this.editpanel,this.UserInfo,this.Processes_Services};
...
return QS.Get();
    ...
    private void getdatabases(int ind)
    {
        ...
        try
        {
            ...
            myconn.Open();
            string command = "SELECT name FROM sys.sysdatabases where name NOT IN ('master', 'tempdb', 'model', 'msdb'); ";
